init -2 python:
    class ProductionLine():
        def __init__(self, destination_inventory): #TODO: Consider storing things like efficiency, batch size, ect. on a per assembly line basis (maybe define it per serum you're producing?)
        ...
        def add_production(self, total_production):
            ...
            if serum_production_cost <= 0:
                serum_production_cost = 10 #Defensive programming in case we assign serum trait costs wrong.
