init 0 python:
    ...
    auto_pumping_stations_policy = Policy(name = "Automatic Breast Pumping Stations",
        desc = "Cutting edge breast pump machinery will be installed in the break room. Unlocks a new duty for lactating staff to provide a larger amount of breast milk at once, if they have enough to give.",
        cost = 5000,
        toggleable = False)
    ...
    serum_policies_list.append(testing_room_creation_policy)
