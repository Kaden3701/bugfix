...
init -2 python:
    ...
    def mom_onlyfans_help_requirement(the_person):
        if not the_person.has_role(onlyfans_role) or the_person.location != mom_bedroom:
            return False
...
label mom_onlyfans_help(the_person):
    ...
    if not the_person.location == mom_bedroom:
            ...
            menu:
                "Get your cock out" if the_person.effective_sluttiness() >= slut_requirement:
                    ...
                    menu:
                        ...
                        "Tell her to suck it\n{color=#ff0000}{size=18}Requires: willing to give blowjob{/size}{/color} (disabled)" if not the_person.is_willing(blowjob):
                            pass
                        ...
                        "Fuck her\n{color=#ff0000}{size=18}Requires: willing to have sex{/size}{/color} (disabled)" if not the_person.is_willing(doggy):
                            pass
                        ...
                        "Anal her\n{color=#ff0000}{size=18}Requires: willing to have anal sex{/size}{/color} (disabled)" if not the_person.is_willing(doggy_anal):
                            pass
                            ...
                            menu:
                                "Interview her":
                                    ...
                                    if the_person.on_birth_control:
                                        ...
                                        if the_person.has_breeding_fetish or the_person.get_opinion_score(["bareback sex", "creampies"]) > 0: #Highly enthusiastic.
                                            $ the_person.update_birth_control_knowledge()
