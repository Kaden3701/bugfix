...
init 700:
    python:
        ...
        def aunt_possessive_titles(person):
            valid_titles = []
            valid_titles.append(person.name)
...
label aunt_sex_beg_finish(the_person):
    the_person "Wait, I really need this [the_person.mc_title]! You're making me feel like a real women, please don't stop! Please!"
    return
