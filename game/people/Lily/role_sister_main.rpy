...
init 1 python:
    ...
    def get_sister_role_actions():
        ...
        sister_girlfriend_underwear_shopping_action = Action("Shop for new lingerie {image=gui/heart/Time_Advance.png}", girlfriend_underwear_shopping_requirement , "girlfriend_underwear_shopping_label",
            menu_tooltip = "Take your girlfriend out to shop for some exciting underwear to wear for you.")

        return [sister_reintro_action, sister_serum_test_action, sister_strip_reintro_action, sister_strip_action, sister_boobjob_give_serum_action, sister_boobjob_ask_action, sister_mom_girlfriend_blessing_action, sister_girlfriend_return_action, sister_girlfriend_underwear_shopping_action]
    ...
    def lily_oral_position_filter(oral_positions):
        return lily.event_triggers_dict.get("kissing_revisit_complete", False)

    def lily_vaginal_position_filter(vaginal_positions):
        return lily.event_triggers_dict.get("anal_revisit_complete", False)

    def lily_anal_position_filter(anal_positions):
...
init -2 python:
    ...
    def sister_strip_reintro_requirement(the_person):
        if not mc.business.event_triggers_dict.get("sister_strip_reintro", False):
            ...
            return "Requires: " + get_gold_heart(30)
        return True
    ...
    def sister_strip_requirement(the_person): #She'll only strip if you're in her bedroom and alone.
        if not mc.business.event_triggers_dict.get("sister_strip",False):
            ...
            return "Requires: $100, " + get_gold_heart(30)
        return True
...
label sister_offer_to_hire(the_person):
    ...
    if the_person.event_triggers_dict.get("dropout_convince_progress", 0) == 2:
        ...
        the_person "I don't know... Maybe. It doesn't matter, you'll never convince mom."
