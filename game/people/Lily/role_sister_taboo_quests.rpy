...
init -1 python:
    def sister_kissing_taboo_revisit_requirement(the_person):
        return the_person.location.person_count <= 1 and not the_person.has_queued_event("sleeping_walk_in_label")
...
label sister_kissing_taboo_break_revisit(the_person):
    ...
    if first_time:
        ...
        if noteable_taboo == "touching":
            ...
            the_person "I don't know, I think that might have been going too far. I don't think mom would have liked it."
    ...
    menu:
        ...
        "But it keeps happening...\n{color=#ff0000}{size=18}Requires: Break taboo [attempts] more times{/size}{/color} (disabled)" if the_person.event_triggers_dict.get("kissing_revisit_count", 0) < kissing_count_threshold:
            pass
...
label sister_oral_taboo_break_revisit(the_person):
    ...
    menu:
        "I know it turned you on" if the_person.get_known_opinion_score("incest") > 0:
            ...
            the_person "Just don't let mom know."
        ...
        "But it keeps happening...\n{color=#ff0000}{size=18}Requires: Break taboo [attempts] more times{/size}{/color} (disabled)" if the_person.event_triggers_dict.get("oral_revisit_count", 0) < oral_count_threshold:
            pass
...
label sister_anal_taboo_break_revisit(the_person):
    ...
    menu:
        ...
        "But it keeps happening...\n{color=#ff0000}{size=18}Requires: Break taboo [attempts] more times{/size}{/color} (disabled)" if the_person.event_triggers_dict.get("anal_revisit_count", 0) < anal_count_threshold:
            pass
        ...
        "Let me change your mind" if not the_person.event_triggers_dict.get("sister_anal_quest_active", False):
            ...
            the_person "What could you possibly do to change my mind? Like, if mom found out about this, she would kill us!"
...
label sister_vaginal_taboo_break_revisit(the_person):
    ...
    menu:
        ...
        "But we've fucked so many times already...\n{color=#ff0000}{size=18}Requires: Break taboo [attempts] more times{/size}{/color} (disabled)" if the_person.event_triggers_dict.get("vaginal_revisit_count", 0) < vaginal_count_threshold:
            pass
