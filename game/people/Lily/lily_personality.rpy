...
init 700:
    python:
        ...
        def lily_possessive_titles(person):
...
label lily_sex_review(the_person, the_report):
    ...
    #She's single, but worried that you did in public.
        ...
        if used_obedience:
            ...
            the_person "What if someone recognizes us? Mom could find out!"
    ...
    #No special conditions, just respond based on how orgasmed and how slutty the position was.
        ...
        if the_person.effective_sluttiness() > comment_position.slut_cap: #She's sluttier than the position
            ...
            "She laughs nervously, trying to hide her embarrassment."
            the_person "Let's not tell mom about this, obviously."
...
label lily_flirt_response_mid(the_person):
    if the_person.effective_sluttiness("underwear_nudity") < 20: #Not very slutty, so it must be high love.
        ...
        the_person "How do I look from behind? It's hard to get a good look in the mirror and mom is always judging what I'm wearing."
...
label lily_flirt_response_high(the_person):
    if mc.location.person_count == 1: #If you are alone she'll flirt with you
        if the_person.effective_sluttiness() > (25 - the_person.get_opinion_score("incest")*5): # High sluttiness flirt
            ...
            the_person "Thanks! I don't really mind, but I think mom would freak out if she heard you talking like that."
        ...
        if the_person.effective_sluttiness() > (25 - the_person.get_opinion_score("incest")*5): #She's slutty, but you need to find somewhere private so people don't find out.
            ...
            the_person "Well... I don't really mind, as long as we're just joking around. I just don't want mom to get upset with us."
    ...
    if the_person.wants_creampie:
        ...
        if not the_person.on_birth_control:
            if the_person.relationship != "Single":
                ...
                $ the_person.update_birth_control_knowledge()
                the_person "What if you got me pregnant? What would mom say?"
...
label lily_kissing_taboo_break(the_person):
    ...
    if the_person.event_triggers_dict.get("kissing_revisit_count", 0) == 0:
        ...
        the_person "You're serious? I... I don't know [the_person.mc_title], what if mom finds out?"
...
label lily_condomless_sex_taboo_break(the_person):
    the_person "I don't like condoms either, but we need to be careful. What would we tell mom if you got me pregnant?"
...
label lily_creampie_taboo_break(the_person):
    if the_person.wants_creampie:
        ...
        if the_person.knows_pregnant:
            ...
            the_person "Yeah, that. Shouldn't we be trying to avoid that? I don't want to have to explain that to mom."
