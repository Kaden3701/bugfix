...
init -2 python:
    def instathot_intro_requirement(the_person): #This action sits in her room
        if the_person.sluttiness < 20:
            ...
            return False
        elif not the_person.location == lily_bedroom:
            return False
    ...
    def instathot_requirement(the_person):
        if not the_person.location == lily_bedroom:
            return False
        elif __builtin__.len(lily_bedroom.people) > 1:
            return False
        elif time_of_day == 4:
    ...
    def add_sister_instahot_action():
        ...
        lily.get_role_reference(sister_role).add_action(sister_instahot_action)
        return
...
label sister_instathot_intro_label(the_person):
    ...
    the_person "You scared me, I thought you were mom for a second."
...
label sister_instathot_label(the_person):
    ...
    if the_person.event_triggers_dict.get("sister_instathot_mom_enabled", False) and mom.is_at_mc_house:
        if mom.event_triggers_dict.get("mom_instathot_pic_count",0) == 0: #It's your first time inviting her.
            ...
            the_person "Yeah! Is mom around? She's been bugging me about wanting to take some pictures together."
            ...
            "[the_person.possessive_title] smiles and nods excitedly."
            the_person "Yeah! Hey, do you think mom would want to join again? Our last shots together did really well."
            menu:
        ...
        menu:
            "Ask to watch":
                ...
                if the_person.get_opinion_score(["showing her tits", "showing her ass", "not wearing anything"]) > 0:
                    ...
                    mc.name "Of course not [the_person.title]. We don't want mom wondering why I'm standing in the hall, right?"
                    ...
                    the_person "Yeah, that's not happening. Come on, we need to do this quick before mom gets curious."
                    $ clear_scene()
                ...
                "I've got another idea...":
                    ...
                    if not isinstance(the_outfit, Outfit):
                        ...
                        if the_person.judge_outfit(the_outfit):
                            ...
                            $ insta_wardrobe.add_outfit(the_outfit) #If she wouldn't wear it normally it's added to the list of insta-appropriate outfits instead
    ...
    if (special_request == "topless" or special_request == "nude") and not the_person.event_triggers_dict.get("sister_insta_special_ignore", False): #One of her viewers has a special request.
        ...
        if the_person.event_triggers_dict.get("sister_insta_special_intro", False): #
            if the_person.event_triggers_dict.get("sister_insta_special_count",0) == 0: #You told her no the first time.
                ...
                the_person "Do you think I should reconsider? Maybe I can split the cash with mom, that way I'm helping everyone!"
                menu:
                    "Take the pictures":
                        mc.name "Well... I guess if it's just a topless shot, and mom could definitely use the cash."
...
label sister_instathot_special_intro(the_person, is_topless_shoot = True):
    ...
    menu:
        ...
        "Ignore them":
            ...
            the_person "Yeah, you're probably right. I would die of embarrassment if mom found them."
    return
...
label sister_instathot_special_pictures(the_person, is_topless_shoot = True):
    ...
    if the_person.effective_sluttiness() >= 35:
        ...
        if not the_person.has_large_tits:
            ...
            the_person "Look at mom, she's got huge boobs! These are..."
            ...
            menu:
                "Get bigger boobs" if Person.rank_tits(the_person.tits) < 8:
                    ...
                    if the_person.event_triggers_dict.get("sister_instathot_mom_enabled", False): #Mom already knows about her "hobby"
                        the_person "And what would I tell mom?"
                        ...
                        the_person "And what would I tell mom? I would have to tell her about my InstaPic account, and she would make me take it down."
...
label sister_instathot_mom_discover(the_person): # TODO: Hook this up as a night time crisis triggered if you tell Mom about Lily's Insta job
    ...
    the_person "Did you really tell mom about my InstaPic profile?"
    ...
    the_person "Now mom wants to see how it's done and take some pictures with me... Ugh..."
    ...
    menu:
        "Dress [mom.title] up":
            mc.name "The pictures don't need to be boring. Dress mom up the same way you normally do."
...
label sister_instathot_label_mom(the_sister, the_mom):
    ...
    if the_mom.event_triggers_dict.get("mom_instathot_pic_count",0) == 0:
        ...
        the_sister "Wait mom, we need him. He's going to take the pictures."
        $ the_group.draw_person(the_mom)
    ...
    $ the_group.draw_person(the_sister)
    the_sister "You look great mom, it's so cute on you!"
    $ the_group.draw_person(the_mom)
    ...
    $ the_group.draw_person(the_sister)
    the_sister "Come on mom, we've got to take some pictures now. Get up here."
            ...
            menu:
                "Take your tits out":
                    ...
                    if the_mom.has_taboo("bare_tits"):#TODO: She's not okay with it until you've broken her taboo.
                        ...
                        $ the_group.draw_person(the_sister)
                        the_sister "Aww come on mom, let's do it! It's just a little bit of fun, and I know [the_sister.mc_title] doesn't care."
                        $ the_group.draw_person(the_mom)
                        ...
                        menu:
                            ...
                            "We're just going to tease them" if the_mom.effective_sluttiness() >= tease_requirement:
                                ...
                                the_sister "Yeah, that's it. You'll do it for me, right mom?"
...
label sister_instathot_label_mom_shirtless(the_sister, the_mom, the_group): #Called when you convince them to take some shirtless pics.
    ...
    "[the_sister.possessive_title] starts to strip off her [the_sister.outfit.get_upper_top_layer.display_name], and [the_mom.possessive_title] follows her lead."
    ...
    if the_sister.event_triggers_dict.get("sister_instathot_mom_shirtless_covered_count", 0) > 0:
        ...
        $ red_heart_token = get_gold_heart(cover_other_requirement)
        ...
        menu:
            ...
            "Cover each other's tits" if (the_mom.effective_sluttiness() >= 50 or the_mom.get_known_opinion_score("incest") > 0) and (the_sister.effective_sluttiness() >= 50 or the_sister.get_known_opinion_score("incest") > 0):
                ...
                mc.name "What do [the_sister.fname]'s tits feel like mom?"
                ...
                if the_sister.event_triggers_dict.get("sister_instathot_mom_shirtless_uncovered_count", 0) > 0:
                    ...
                    $ red_heart_token = get_gold_heart(show_them_requirement)
                    ...
                    menu:
                        "Now show them to the camera" if (the_mom.effective_sluttiness() >= show_them_requirement or the_mom.get_known_opinion_score("incest") > 0) and (the_sister.effective_sluttiness() >= show_them_requirement or the_sister.get_known_opinion_score("incest") > 0):
                            ...
                            if first_time:
                                ...
                                the_sister "Come on mom, just show them off a little!"
                                $ the_group.draw_person(the_mom)
                    ...
                    $ the_group.draw_person(the_sister)
                    the_sister "It's fine mom, it's fun!"
                    $ the_group.draw_person(the_mom)
...
label sister_instathot_mom_report(the_person): #Lily tells you that her shots with Mom were super popular and that you want to do more
    $ the_person.draw_person(emotion = "happy")
    the_person "Hey, so you know those pics we took with mom?"
    ...
    the_person "I don't think mom would be okay with that. Plus I would be so embarrassed if I had to tell her."
...
label sister_convince_mom_boobjob(the_mom, the_sister):
    if the_sister.event_triggers_dict.get("mom_boobjob_convince_first_try", True):
        ...
        $ the_group.draw_person(the_sister, position = "kneeling1")
        the_sister "You're lucky mom, I wish my boobs had grown in to be as big as yours."
    ...
    $ sluttiness_token = get_gold_heart(sluttiness_required)
    menu:
        "[the_sister.title] would look so hot!" if the_mom.effective_sluttiness() >= sluttiness_required:
            ...
            $ the_group.draw_person(the_sister, position = "kneeling1")
            $ mc.change_locked_clarity(20)
            the_sister "Please mom? I just want to have big boobs like I've always wanted. Boobs like yours."
        ...
        "Order [the_sister.title] to do it anyways" if the_sister.obedience >= 140:
            ...
            the_sister "Okay, then I'm going to do it! I'm sorry mom, but it's important to me!"
            $ the_group.draw_person(the_mom, position = "kneeling1")
...
label sister_serum_partial_boobjob_label(starting_tits, the_person):
    ...
    if the_person.event_triggers_dict.get("sister_boobjob_serum_count", 0) == 0:
        ...
        the_person "Do you actually have any, or should we try convincing mom to let me get implants instead?"
        menu:
        ...
        if the_person.rank_tits(the_person.tits) == the_person.rank_tits(starting_tits):
            ...
            the_person "I guess the only thing left is to get implants. That means we need to convince mom."
            mc.name "I'll bring it up next time you're taking InstaPic's with her."
            the_person "Okay, I hope you're convincing!"
        ...
        the_person "The only thing left to do is to get implants. That means we need to convince mom."
        mc.name "I'll bring it up next time you're taking InstaPic's with her."
        the_person "Okay, I hope you're convincing!"
        $ the_person.event_triggers_dict["sister_boobjob_convince_mom_enabled"] = True
