...
init 1 python:
    ...
    def create_penelope_character():
        ...
        global city_rep
        city_rep = create_random_person(name = "Penelope", age = 34, body_type = "thin_body", face_style = "Face_9", tits = "D", height = 1.02, hair_colour = "black", hair_style = ponytail, pubes_style = trimmed_pubes, skin = "white", \
