...
init -1 python:
    ...
    def punishment_serum_test_requirement(the_person, the_infraction):
        if not mandatory_paid_serum_testing_policy.is_active:
            ...
            return "Severity 1"
        elif mc.inventory.total_serum_count == 0:
...
label punishment_verbal_scolding(the_person, the_infraction): #Note: Pass the infraction so we can reference it if we want.
    ...
    $ the_person.change_stats(happiness = -2 + the_person.get_opinion_score("being submissive"), obedience = 1 + the_person.get_opinion_score("being submissive"))
    ...
    menu:
        "Keep going":
            ...
            $ the_person.change_stats(happiness = -5 + (2*the_person.get_opinion_score("being submissive")), obedience = 2 + the_person.get_opinion_score("being submissive"))
            menu:
                "Insult her":
                    ...
                    if the_person.obedience < (90 - (15*the_person.get_opinion_score("being submissive"))):
                        ...
                        $ the_person.change_stats(happiness = -10, love = -2, obedience = 2 + the_person.get_opinion_score("being submissive"))
...
label punishment_wrist_slap(the_person, the_infraction):
    ...
    $ the_person.change_stats(love = -1 + the_person.get_opinion_score("being submissive"), obedience = 2 + the_person.get_opinion_score("being submissive"))
    ...
    menu:
        "Keep going":
            ...
            $ the_person.change_stats(love = -2 + the_person.get_opinion_score("being submissive"), obedience = 2 + the_person.get_opinion_score("being submissive"))
...
init -1 python:
    ...
    def punishment_underwear_only_requirement(the_person, the_infraction):
        ...
        elif the_person.vagina_visible and the_person.tits_visible:
            return "Already naked"
        elif the_person.are_panties_visible and the_person.is_bra_visible:
    ...
    menu:
        ...
        "Teach her a lesson":
            ...
            if not_cushioned: #Ass gets red, she gets sore.
                ...
                $ the_person.draw_person()
                if the_person.get_opinion_score("being submissive") > 0:
                    $ the_person.change_stats(arousal = 5 * the_person.get_opinion_score("being submissive"), obedience = the_person.get_opinion_score("being submissive"))
                    the_person "Thank you [the_person.mc_title]. I promise I'll do better."
                else:
                    $ the_person.change_stats(love = -2 + the_person.get_opinion_score("being submissive"), obedience = 3)
...
label punishment_underwear_only(the_person, the_infraction):
    ...
    if not (the_person.has_underwear): # Whoops, not wearing underwear today! Tough luck.
        ...
        if the_person.effective_sluttiness() < slut_continue_requirement:
            ...
            $ the_person.change_stats(happiness = -5, obedience = 2 + the_person.get_opinion_score("being submissive"))
    ...
    $ the_person.set_uniform(the_person.event_triggers_dict["forced_uniform"])
    $ clear_scene()
    return
