...
label grope_ass(the_person):
    ...
    if the_person.effective_sluttiness("touching_body") < 15:
        ...
        if the_person.effective_sluttiness("touching_body") < 20:
            ...
            $ the_person.change_stats(arousal = 1 + mc.sex_skills["Foreplay"], love = -1, slut = 1, max_slut = 20)
            ...
            $ the_person.change_arousal(1 + mc.sex_skills["Foreplay"])
...
label grope_tits(the_person):
    ...
    if the_person.effective_sluttiness("touching_body") < 20:
        ...
        if the_person.effective_sluttiness("touching_body") < 25:
            ...
            $ the_person.change_stats(arousal = 3 + mc.sex_skills["Foreplay"], slut = 1, max_slut = 25)
            ...
            if the_person.has_taboo("touching_body"):
                ...
                $ the_person.change_arousal(3 + mc.sex_skills["Foreplay"])
