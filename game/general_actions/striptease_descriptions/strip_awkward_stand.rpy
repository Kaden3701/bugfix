...
label strip_awkward_stand_away_1(the_person, guy_state, for_pay = False):
    ...
    if the_person.vagina_visible:
        ...
        "She runs a hand over her [the_person.outfit.get_lower_top_layer.display_name], then gives herself the worlds lightest spank."
...
label strip_awkward_stand_climax(the_person, guy_state, for_pay = False): #TODO: Link this with some personality dialogue
    ...
    $ the_person.have_orgasm(trance_chance_modifier = the_person.get_opinion_score(["public sex", "masturbating"]), reset_arousal = False)
