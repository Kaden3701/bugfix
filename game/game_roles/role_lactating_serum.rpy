...
label milk_for_serum_label(the_person):
    ...
    if the_person.has_role(girlfriend_role) or the_person.has_role(affair_role) or the_person.has_breeding_fetish or the_person.effective_sluttiness() + 5*the_person.get_opinion_score("showing her tits") > 50:
    ...
    if milking_allowed:
        ...
        menu:
            "Milk her yourself" if the_person.effective_sluttiness() >= sluttiness_required or the_person.has_role(girlfriend_role) or the_person.has_role(affair_role) or the_person.has_breeding_fetish:
                ...
                if available_doses == 0:
                    ...
                    menu:
                        ...
                        "Milk her {i}hard{/i}":
                            ...
                            if the_person.has_breeding_fetish or the_person.get_opinion_score("being submissive") > 0:
