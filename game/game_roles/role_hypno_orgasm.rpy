...
label hypno_trigger_orgasm(the_person, use_intro = True):
    ...
    if the_person.arousal_perc < 50:
        ...
        $ the_person.have_orgasm(trance_chance_modifier = the_person.get_opinion_score("being submissive")) #ie. positive opinions of being in submissive make her more likely to trance off of this.
        ...
        $ the_person.have_orgasm(trance_chance_modifier = the_person.get_opinion_score("being submissive")) #ie. positive opinions of being submissive make her more likely to trance off of this.
        ...
        menu:
            "Catch her":
                ...
                $ the_person.have_orgasm(trance_chance_modifier = the_person.get_opinion_score("being submissive"))
...
label hypno_trigger_online(the_person):
    ...
    mc.name "[the_word]."
    $ the_person.have_orgasm(trance_chance_modifier = the_person.get_opinion_score("being submissive"), add_to_log = False) #ie. positive opinion of being submissive make her more likely to trance off of this.
