...
init 0 python:
    ...
    def supply_work_duty_on_turn(the_person):
        ...
        mc.business.supply_purchase(the_person.focus, the_person.charisma, the_person.supply_skill, the_person.calculate_job_efficiency(), cost_modifier)

    def heavy_supply_work_duty_on_turn(the_person):
        cost_modifier = get_duty_supply_cost_modifier(the_person)

        mc.business.supply_purchase(the_person.focus, the_person.charisma, the_person.supply_skill, the_person.calculate_job_efficiency() * 0.5, cost_modifier)
    ...
    def research_work_duty_on_turn(the_person):
        research_amount = mc.business.research_progress(the_person.int, the_person.focus, the_person.supply_skill, the_person.calculate_job_efficiency())
        research_clarity_production_check(the_person ,research_amount)

    def heavy_research_work_duty_on_turn(the_person):
        research_amount = mc.business.research_progress(the_person.int, the_person.focus, the_person.supply_skill, the_person.calculate_job_efficiency() * 0.5)
        research_clarity_production_check(the_person, research_amount)
        the_person.change_happiness(-2, add_to_log = False)

    def research_journal_on_apply(the_person): #Done on_apply and on_remove so the ocsts will display as ongoing operation costs.
    ...
    def production_work_duty_on_turn(the_person):
        mc.business.production_progress(the_person.focus, the_person.int, the_person.production_skill, the_person.calculate_job_efficiency())

    def heavy_production_work_duty_on_turn(the_person):
        mc.business.production_progress(the_person.focus, the_person.int, the_person.production_skill, the_person.calculate_job_efficiency()*0.5)
        the_person.change_happiness(-2, add_to_log = False)

    def bend_safety_rules_on_turn(the_person):
        mc.business.production_progress(the_person.focus, the_person.int, the_person.production_skill, the_person.calculate_job_efficiency()*0.25)
    ...
    def market_work_duty_on_turn(the_person):
        ...
        mc.business.sale_progress(the_person.charisma, the_person.focus, work_skill, the_person.calculate_job_efficiency())
    ...
    def heavy_market_work_duty_on_turn(the_person):
        ...
        if the_person.has_duty(work_for_tips_duty):
            if the_person.effective_sluttiness() < 25:
                ...
                work_skill += the_person.sex_skills["Oral"]
        mc.business.sale_progress(the_person.charisma, the_person.focus, work_skill, the_person.calculate_job_efficiency()*0.5)
        the_person.change_happiness(-2, add_to_log = False)
    ...
    def client_demonstration_duty_on_turn(the_person):
        mc.business.sale_progress(0, 0, the_person.sex_skills["Foreplay"], the_person.calculate_job_efficiency())
        if renpy.random.randint(0, 100) < 5:
            the_person.give_serum(mc.business.get_random_weighed_production_serum())
            the_person.change_happiness(-2, add_to_log = False)
    ...
    def hr_work_duty_on_turn(the_person):
        mc.business.hr_progress(the_person.charisma, the_person.int, the_person.hr_skill, the_person.calculate_job_efficiency())

    def heavy_hr_work_duty_on_turn(the_person):
        mc.business.hr_progress(the_person.charisma, the_person.int, the_person.hr_skill, the_person.calculate_job_efficiency()*0.5)
        the_person.change_happiness(-2, add_to_log = False)
    ...
    def daily_serum_dosage_duty_on_move(the_person):
        ...
        give_daily_serum_dosage(the_person)
        return

    def give_daily_serum_dosage(the_person):
        the_serum = None
    ...
    def social_media_advertising_duty_on_turn(the_person):
        ...
        if the_person.event_triggers_dict.get("onlyfans_known", False):
            effect += 0.1
        mc.business.hr_progress(the_person.charisma, the_person.int, work_skill, the_person.calculate_job_efficiency()*effect)
    ...
    def find_infractions_duty_on_turn(the_person):
        if renpy.random.randint(0,100) < 10: #NOTE: This is different from 5% so we can have low obedience/rival employees show up more often.
            ...
            the_target = get_random_from_list(mc.business.employee_list)
