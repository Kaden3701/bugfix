...
init -2 python:
    def employee_on_turn(the_person):
        ...
        if mc.business.is_work_day and the_person.is_at_work: #Only thinks about quitting/asking for a promotion when she's at work
            ...
            happy_points = the_person.job_happiness_score
        ...
        "Reward her for work well done":
            ...
            menu:
                ...
                "Give her a raise\n{color=#ff0000}{size=18}Costs: $[raise_amount] / day{/size}{/color}": #Pay her more money. Large happiness and obedience raise.
                    ...
                    $ the_person.change_stats(happiness = 5 + mc.charisma, obedience = mc.charisma)
        ...
        "Punish her for poor performance":
            ...
            menu:
                ...
                "Cut her pay\n{color=#00ff00}{size=18}Saves: $[cut_amount] / day{/size}{/color}": #Pay her less. Large happiness and obedience drop.
                    ...
                    elif the_person.job_happiness_score > -25:
                ...
                "Threaten to fire her": #She may ask to stay in exchange for some sort of favour, or get fired on the spot.
                    ...
                    if the_person.job_happiness_score > -10:
                            ...
                            menu:
                                "Make her strip":
                                    ...
                                    if the_person.has_taboo("underwear_nudity"):
                                        ...
                                        $ the_person.change_stats(love = -1, obedience = 2 + the_person.get_opinion_score("being submissive"))
                                    ...
                                    $ the_person.change_stats(happiness = -5 + (the_person.get_opinion_score(["showing her tits", "showing her ass"])), obedience = 3 + the_person.get_opinion_score("being submissive"), slut = 1, max_slut = 40)
                                ...
                                "Make her jerk you off" if the_person.is_willing(handjob):
                                    ...
                                    if the_report.get("guy orgasms", 0) > 0:
                                        ...
                                        if office_punishment.is_active:
                                            ...
                                            mc.name "You did, that's true. I'll be generous this time, but you better be prepared to finish me next time."
                                            the_person "Next time? I mean, of course [the_person.mc_title]."
                                    $ the_person.change_stats(happiness = -5 + (2*the_person.get_opinion_score("giving handjobs")), obedience = 1 + the_person.get_opinion_score("being submissive"), slut = 1 + the_person.get_opinion_score("giving handjobs"), max_slut = 50)
                                    $ the_person.review_outfit()
                                    $ the_person.draw_person()

                                "Make her jerk you off\n{color=#FF0000}{size=16}Requires: handjob available{/size}{/color} (disabled)" if not the_person.is_willing(handjob):
                                    pass
                                ...
                                "Make her blow you" if the_person.is_willing(blowjob):
                                    ...
                                    $ the_person.change_stats(happiness = -5 + the_person.get_opinion_score("giving blowjobs"), obedience = 1 + the_person.get_opinion_score("being submissive"), slut = 2, max_slut = 60)
                                ...
                                "Make her blow you\n{color=#FF0000}{size=16}Requires: blowjob available{/size}{/color} (disabled)" if not the_person.is_willing(blowjob):
                                    pass
                                ...
                                "Fuck her" if the_person.is_willing(standing_doggy):
                                    ...
                                    if the_person.wants_condom():
                                        ...
                                        menu:
                                            ...
                                            "Fuck her raw anyways\n{color=#FF0000}{size=16}Requires: 130 Obedience{/size}{/color} (disabled)" if the_person.obedience < 130:
                                                pass
                                    ...
                                    $ the_person.change_stats(happiness = -4 + the_person.get_opinion_score(["sex standing up", "vaginal sex"]), obedience = 2 + the_person.get_opinion_score(["sex standing up", "vaginal sex"]), slut = 2, max_slut = 80)
                                    $ the_person.review_outfit()
                                    $ the_person.draw_person()
                                    mc.name "Okay [the_person.title], I'll keep you around for a little while longer, but you're going to need to shape up unless you want this to be a regular occurrence."
                                    if the_person.effective_sluttiness() < 50:
                                ...
                                "Fuck her\n{size=16}{color=#FF0000}Requires: sex available{/color}{/size} (disabled)" if not the_person.is_willing(standing_doggy):
                                    pass
    ...
    menu:
        ...
        "Refuse":
            ...
            if the_person.effective_sluttiness() + the_person.get_opinion_score("being in control") * 5 < 40 and not the_person.has_role(affair_role): #Girls you are having an affair with will always try to seduce you and get a promotion.
                $ the_person.change_happiness(-5 + 3 * the_person.get_opinion_score("being submissive"))
                ...
                menu:
                    ...
                    "Make her jerk you off\n{color=#ff0000}{size=18}Requires: handjob available{/size}{/color} (disabled)" if not the_person.is_willing(handjob):
                        pass
                    ...
                    "Make her blow you\n{color=#ff0000}{size=18}Requires: blowjob available{/size}{/color} (disabled)" if not the_person.is_willing(blowjob):
                        pass
                    ...
                    "Fuck her\n{color=#ff0000}{size=18}Requires: sex available{/size}{/color} (disabled)" if not the_person.is_willing(standing_doggy):
                        pass
