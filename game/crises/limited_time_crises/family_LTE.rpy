init -1 python:
    def sister_walk_in_requirement(the_person):
        if not the_person.has_role(sister_role):
            ...
            return False
        elif lily_bedroom.person_count > 1:
            return False
        return True
    ...
    def nude_walk_in_requirement(the_person):
        if not (the_person.has_role(sister_role) or the_person.has_role(mother_role)):
            ...
            return False
        elif the_person.home.person_count > 1:
            return False
        return True
    ...
    def mom_breeding_intro_requirement(the_person):
        if not the_person.has_role(mother_role):
            ...
            return False
        elif mom_bedroom.person_count > 1:
            return False
        elif the_person.has_taboo("vaginal_sex"):
            return False
        elif time_of_day == 0 and mom.has_queued_event("sleeping_walk_in_label"):
            return False
    ...
    def cousin_home_panties_requirement(the_person):
        if not the_person.has_role(cousin_role):
            return False
        elif not the_person.location == cousin_bedroom:
            return False
        return True
    ...
    def mom_go_shopping_requirement(the_person):
        if not the_person.has_role(mother_role):
            return False
        elif not the_person.is_at_mc_house:
            return False
        elif not (time_of_day == 3):
            return False
        return True
...
label breeding_mom_intro_label(the_person):
    ...
    menu:
        "Try to breed her":
            ...
            $ the_person.draw_person(position = "missionary")
            $ the_person.strip_to_vagina(visible_enough = True, delay = 0)
...
label sister_go_shopping_label(the_person): #TODO: Hook this up as an on_enter event in her room.
    ...
    if the_person.love < 10:
        ...
        the_person "Tell mom I'm at the mall if she needs me. See ya later!"
        ...
        menu:
            ...
            "Say goodbye":
                ...
                the_person "Tell mom where I am if she needs me, okay? See ya later!"
                "[the_person.possessive_title] hurries past you and out of the house."
