...
screen character_create_screen():
    if persistent.stats:
        default cha = 0 if not persistent.stats.has_key('cha') else persistent.stats['cha']
        default int = 0 if not persistent.stats.has_key('int') else persistent.stats['int']
        default foc = 0 if not persistent.stats.has_key('foc') else persistent.stats['foc']

        default h_skill = 0 if not persistent.stats.has_key('h_skill') else persistent.stats['h_skill']
        default m_skill = 0 if not persistent.stats.has_key('m_skill') else persistent.stats['m_skill']
        default r_skill = 0 if not persistent.stats.has_key('r_skill') else persistent.stats['r_skill']
        default p_skill = 0 if not persistent.stats.has_key('p_skill') else persistent.stats['p_skill']
        default s_skill = 0 if not persistent.stats.has_key('s_skill') else persistent.stats['s_skill']

        default F_skill = 0 if not persistent.stats.has_key('F_skill') else persistent.stats['F_skill']
        default O_skill = 0 if not persistent.stats.has_key('O_skill') else persistent.stats['O_skill']
        default V_skill = 0 if not persistent.stats.has_key('V_skill') else persistent.stats['V_skill']
        default A_skill = 0 if not persistent.stats.has_key('A_skill') else persistent.stats['A_skill']
