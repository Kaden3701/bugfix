init 10 python:
    ...
    def generate_stat_slug(clothing): #Generates a string of text/tokens representing what layer this clothing item is/covers
        ...
        cloth_info += " +{} {{image=gold_heart_token_small}}".format(clothing.slut_score)
        return cloth_info
                    ...
                    vbox:
                        grid 2 1:
                            ...
                            frame:
                                background "#0a142688"
                                xfill True
                                textbutton "Current ({})".format(Outfit.classification(get_slut_score())):
                                    ...
                                    frame:
                                        ...
                                        viewport:
                                            ...
                                            vbox:
                                                ...
                                                #     xsize 250
                                                #     padding (1,1)
                                                #     text "Body score: " + str(demo_outfit.__get_body_parts_slut_score()) style "serum_text_style_traits"
                                                # frame:
                                                #     background "#143869"
                                                #     xsize 250
                                                #     padding (1,1)
                                                #     text "Slut score: " + str(demo_outfit.__get_total_slut_modifiers()) style "serum_text_style_traits"
                                    ...
                                    vbox:
                                        ...
                                        textbutton ("Export to [selected_xml]" if mannequin == "mannequin" else "Add to [mannequin.name] wardrobe"):
                                            ...
                                            if mannequin == "mannequin":
                                                action [
                                                    Function(custom_log_outfit, demo_outfit, outfit_class = outfit_type,
