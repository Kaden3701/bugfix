...
init 1 python:
    ...
    def anal_fetish_mom_intro_requirement():
        if time_of_day == 4 and mc.is_home and mom.is_available: #Nighttime event
            return True
        return False
...
label anal_fetish_mom_intro_label():
    ...
    "[the_person.possessive_title] goes slow, but steadily slides down, impaling her sphincter on your throbbing erection."
    $ play_moan_sound()
