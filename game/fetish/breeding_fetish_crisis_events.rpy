    ...
    if the_person == lily:
        ...
        menu:
            "Not tonight" if mc.lust_tier < 3:
                ...
                return
            "Not tonight\n{color=ff0000}{size=18}Too much Lust to say No{/size}{/color} (disabled)" if mc.lust_tier > 2:
                pass
            "Strip first":
        ...
        menu:
            "Not tonight" if mc.lust_tier < 3 or mc.energy < 80:
                ...
                $ the_person.change_stats(happiness = -5, obedience = -2)
                return
            "Not tonight\n{color=ff0000}{size=18}Too much Lust to say No{/size}{/color} (disabled)" if mc.lust_tier > 2 and mc.energy > 80:
                pass
            "Let Her":
