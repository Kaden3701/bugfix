init -1 python:
    def start_breeding_fetish_quest(person):
        ...
        if not is_breeding_fetish_unlocked():
            return False
        if person.has_started_breeding_fetish:
            return False
        ...
        #     pass
        # elif person is camilla and False: # she can't get pregnant
        #     pass
    ...
    def breeding_fetish_family_intro_requirement(the_person):
        if the_person.is_home:
            if the_person.location.person_count == 1: #She is alone in her bedroom
                return True
        return False
    ...
    def breeding_fetish_sarah_intro_requirement():
        if not day%7 == 5 and mc.is_in_bed and sarah_threesomes_unlocked() and sarah.is_available:
            return True
        return False
    ...
    def breeding_fetish_erica_intro_requirement():
        if mc.is_in_bed and day%7 != 6 and erica.is_available:
            return True
        return False
...
label breeding_fetish_employee_intro_label(the_person):
    ...
    "As you finish those words, your push yourself inside of her."
    $ play_moan_sound()
...
label breeding_fetish_family_intro_label(the_person):
    ...
    $ play_moan_sound()
    "She moans as you bottom out inside of her and start to fuck."
