...
label ask_location_label(the_person):
    ...
    if the_person.location == mc.location: #She's in the same location as you.
        $ mc.end_text_convo()
        ...
        if the_person.location == the_person.home:
            ...
            the_person "You can find me at [the_person.location.name] right now."
    return return_to_phone

label text_chat_label(the_person):
    $ return_to_phone = True
    if mc.location == the_person.location: #She's in the same location as you.
...
label text_flirt_label(the_person, apply_energy_cost = True, skip_intro = True):
    $ return_to_phone = True
    if mc.location == the_person.location and not skip_intro: #She's in the same location as you.
